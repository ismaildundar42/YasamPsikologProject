...
-- Yeni backup dosyasını restore et
RESTORE DATABASE YasamPsikologDb
FROM DISK = '/var/opt/mssql/data/YasamPsikologDbNew.bak'
WITH 
...
SELECT 'Database restored successfully from YasamPsikologDbNew.bak!' AS Status;
GO
